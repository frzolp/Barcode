...
public class BarcodeGUI extends JFrame implements ActionListener {
	...
	private final JTextField barcodeTxt = new JTextField();
	private final JMenuBar menuBar = new JMenuBar();
	private final JMenu mnDatabase = new JMenu("Database");
	private final JMenuItem mntmShowDbEditor = new JMenuItem("Show DB Editor...");
	...
	public BarcodeGUI() {
		...
		gbc_barcodeTxt.gridx = 0;
		gbc_barcodeTxt.gridy = 3;
		getContentPane().add(barcodeTxt, gbc_barcodeTxt);
		...
		mnDatabase.add(mntmShowDbEditor);
		setVisible(true);
	}
